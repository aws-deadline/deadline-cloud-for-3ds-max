...
from deadline.max_submitter.update_utils import (
    _check_for_update,
    _session_state,
    check_and_show_update_dialog,
)

MODULE = "deadline.max_submitter.update_utils"
...
class TestCheckForUpdate:
    ...
    def test_passes_correct_integration_name(self, mock_check):
        ...
        assert call_kwargs["integration_name"] == "deadline-cloud-for-3ds-max"
...
class TestCheckAndShowUpdateDialog:
    ...
    def test_dialog_receives_correct_release_notes_url(self, mock_check, mock_dialog_cls):
        ...
        assert (
            ...
            == "https://github.com/aws-deadline/deadline-cloud-for-3ds-max/releases"
        )
