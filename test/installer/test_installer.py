...
def installer_path():
    path = "DeadlineCloudFor3dsMaxSubmitter-{platform}-installer.{ext}"
...
def _validate_files(installation_path: Path) -> None:
    ...
    assert "_version.py" in max_submitter_dir
...
def test_default_location(installer_path: Path):
    ...
    --prefix <prefix>                           Installation Directory
                                                Default: /home/<user>/DeadlineCloudFor3dsMaxSubmitter
    """
    # GIVEN
    default_install_location = Path("~/DeadlineCloudFor3dsMaxSubmitter").expanduser()
